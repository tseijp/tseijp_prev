...
urlpatterns = [
    ...
    path('posted/frame/<int:pk>' , NotePostedFrameView.as_view() , name='note_posted_frame'),
    path('update/frame/<int:pk>' , NoteUpdateFrameView.as_view() , name='note_update_frame'),
]
