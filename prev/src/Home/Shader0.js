...
const Noise = () => {
    ...
    useFrame(({mouse})=>{
        ref.current.material.uniforms.uTime.value+=100;
        ref.current.material.uniforms.uMouse.value={x:mouse.x*size.width/2,y:mouse.y*size.height/2};
    ...
    return (
        <mesh ref={ref}>
            {console.log(ref)}
            <planeGeometry  attach="geometry" width={2} height={2}/>
